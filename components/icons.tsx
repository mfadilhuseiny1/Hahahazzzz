...
export const DashboardLogoIcon = ({ size = 17 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const DatabaseIcon = ({ size = 17 }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={{ color: 'currentcolor' }}
    >
      <path d="M12 2C7.58 2 4 3.79 4 6v12c0 2.21 3.58 4 8 4s8-1.79 8-4V6c0-2.21-3.58-4-8-4zm0 2c3.87 0 7 1.12 7 2s-3.13 2-7 2-7-1.12-7-2 3.13-2 7-2zm0 16c-3.87 0-7-1.12-7-2v-1.11c1.66.72 4.09 1.11 7 1.11s5.34-.39 7-1.11V18c0 .88-3.13 2-7 2zm0-4c-3.87 0-7-1.12-7-2v-1.11c1.66.72 4.09 1.11 7 1.11s5.34-.39 7-1.11V14c0 .88-3.13 2-7 2zm0-4c-3.87 0-7-1.12-7-2V8.89c1.66.72 4.09 1.11 7 1.11s5.34-.39 7-1.11V10c0 .88-3.13 2-7 2z" />
    </svg>
  );
};
